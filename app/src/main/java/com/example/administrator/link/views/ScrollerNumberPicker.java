...
//    //选择的内容
//    private ArrayList<ItemObeject> itemlist = new ArrayList<>();
//    //设置数据
...
//    //默认字体颜色
//    private int nomalColor = 0xff000000;
//    //选中字体颜色
//    private int slectorColor = 0xffff0000;
//    //蒙板高度
//    private float maskHeight = 48.0f;
//    //选择监听
//    private OnSelecteListhener onSelecteListhener;
//    //是否可用
...
//    }
//
//    public ScrollerNumberPicker(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            controlWidth = getWidth();
//            Log.e("controlWidth-------->",controlWidth+"");
//        }
//    }
//
//    @Override
...
//        for (ItemObeject item : itemlist) {
//            if (item.isSelected()) {
//                if (onSelecteListhener != null) {
//                    onSelecteListhener.endSelect(item.id, item.itemText);
//                }
//                break;
//            }
//        }
...
//            ItemObeject itemObject = new ItemObeject();
//            itemObject.id = i;
...
//        Log.e("actionThreadMove--move>",move+"");
//        for (ItemObeject item : itemlist) {
//            item.move(move);
//        }
//        sendMessage();
...
//                    if (onSelecteListhener != null) {
//                        onSelecteListhener.endSelect(itemlist.get(i).id,
...
//    }
//
//    private void onSelectedListhener() {
//        if (onSelecteListhener == null) {
//            return;
//        }
//        for (ItemObeject item : itemlist) {
//            if (item.isSelected()) {
//                onSelecteListhener.selecting(item.id, item.itemText);
//            }
//        }
//    }
//
...
//        TypedArray arribute = context.obtainStyledAttributes(attrs, R.styleable.NumberPicker);
//        unitHeight = (int) arribute.getDimension(R.styleable.NumberPicker_unitHight, 32);
//        nomalFont = arribute.getDimension(R.styleable.NumberPicker_normalTextSize, 14.0f);
//        selectedFont = arribute.getDimension(R.styleable.NumberPicker_selecredTextSize, 22.0f);
//        itemNumber = arribute.getInt(R.styleable.NumberPicker_itemNumber, 7);
//        nomalColor = arribute.getColor(R.styleable.NumberPicker_normalTextColor, 0xff000000);
//        slectorColor = arribute.getColor(R.styleable.NumberPicker_selecredTextColor, 0xffff0000);
//        lineColor = arribute.getColor(R.styleable.NumberPicker_lineColor, 0xff000000);
//        maskHeight = arribute.getDimension(R.styleable.NumberPicker_maskHight, 48.0f);
//        noEmpty = arribute.getBoolean(R.styleable.NumberPicker_noEmpty, false);
//        isEnable = arribute.getBoolean(R.styleable.NumberPicker_isEnable, true);
//        arribute.recycle();
...
//    }
//
//    public void setOnSelecteListhener(OnSelecteListhener onSelecteListhener) {
//        this.onSelecteListhener = onSelecteListhener;
//    }
//
//    public interface OnSelecteListhener {
//        /***
//         * 结束选择
//         *
//         * @param id
...
//            //判断是否被选择
//            if (isSelected()) {
//                textPaint.setColor(slectorColor);
//                float moveToSelect = moveToSelected();
//                //获取距离标准位置的距离
//                moveToSelect = moveToSelect > 0 ? moveToSelect : moveToSelect * (-1);
//                //计算当前字体的大小
//                float textSize = (float) nomalFont + ((float) (selectedFont - nomalFont) * (1.0f -
//                        (float) moveToSelect/ (float) unitHeight));
//                textPaint.setTextSize(textSize);
//            } else {
//                textPaint.setColor(nomalColor);
//                textPaint.setTextSize(nomalFont);
//            }
//            //画一个可以包围字符串的最小的Rect区域
